...
## Test Status
- Backend: **189 / 190 collected, 0 failures, 1 intentional skip** across 10 iterations.
- Frontend: testing-agent iteration 10 — Landing live-pool-badge "POOL · OFFLINE (HONEST)" verified next to Series-A rosette with config-hint sub message; auto-refresh observed; admin Real-Android PoolStatusPanel regression GREEN against the moved /api/admin/pool/status route.
